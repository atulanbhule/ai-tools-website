      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/#content-generation" className="text-gray-300 hover:text-white transition-colors">Content Generation</Link></li>
              <li><Link href="/#image-generation" className="text-gray-300 hover:text-white transition-colors">Image Generation</Link></li>
              <li><Link href="/#productivity" className="text-gray-300 hover:text-white transition-colors">Productivity</Link></li>
              <li><Link href="/#development" className="text-gray-300 hover:text-white transition-colors">Development</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          ...
          <div className="mt-2">
            <Link href="/privacy-policy" className="text-gray-400 hover:text-white transition-colors mx-2">Privacy Policy</Link>
            <Link href="/terms-of-service" className="text-gray-400 hover:text-white transition-colors mx-2">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
